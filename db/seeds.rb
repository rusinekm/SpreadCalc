...
CurrencySite.create(site_id: kantor_internetowy.id, currency_id: gbp.id, buy_parsing_class:"css('#waluta-GBP').css('.kurs_kupna')", sell_parsing_class:"css('#waluta-GBP').css('.kurs_sprzedazy')")
...
CurrencySite.create(site_id: cinkciarz.id, currency_id: gbp.id, buy_parsing_class:"css('span[title=\"Funt brytyjski\"]').first.parent.parent.css('td')[1]", sell_parsing_class:"css('span[title=\"Funt brytyjski\"]').first.parent.parent.css('td')[2]")
...
CurrencySite.create(site_id: kantor_pl.id, currency_id: gbp.id, buy_parsing_class:"css('a[title=\"Kursy walut - Funt Brytyjski\"]').first.parent.parent.css('td')[3]", sell_parsing_class:"css('a[title=\"Kursy walut - Funt Brytyjski\"]').first.parent.parent.css('td')[4]")
...
CurrencySite.create(site_id: kantorwarszawa.id, currency_id: gbp.id, buy_parsing_class:"css('img[title=\"kantor flaga Wielkiej Brytanii\"]').first.parent.parent.css('td')[5]", sell_parsing_class:"css('img[title=\"kantor flaga Wielkiej Brytanii\"]').first.parent.parent.css('td')[6]")
